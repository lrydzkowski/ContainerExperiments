...
using ContainerExperiments.WebApi1.Client.Models;

namespace ContainerExperiments.WebApi1.Client.Services;
    ...
    : IAppInfoService
{
    ...
    {
        HttpClient client = _httpClientFactory.CreateClient(nameof(WebApi1HttpClient));
