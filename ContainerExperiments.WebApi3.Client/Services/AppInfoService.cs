...
using ContainerExperiments.WebApi3.Client.Models;

namespace ContainerExperiments.WebApi3.Client.Services;
    ...
    : IAppInfoService
{
    ...
    {
        HttpClient client = _httpClientFactory.CreateClient(nameof(WebApi3HttpClient));
